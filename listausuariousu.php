...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
      <br>
     <a href="registroClienteusu.php" class="btn btn-primary">Registro Cliente</a>  
...
while($r=$products->fetch_object()):
  ?>
<tr>
  <td><center><a href="clienteconsultausu.php?id=<?php echo $r->cliente_cedula;?>"><?php echo $r->cedula;?></a></td>
