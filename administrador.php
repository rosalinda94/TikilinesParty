    ...
    <?php 
        ...
        if(!isset($_SESSION)){
            ...
            if(empty($_SESSION['administrador'])){
                ?><center>      <tr>
        <td width="554" align="center"><img src="images/ca.jpg" width="100" height="100"  alt=""/></td>
        </tr>
      <tr>
            <form action="login.php" method="POST">   
                    <h2>Inicie Sesion para administrador</h2>
        ...
        echo "<a href='salirSesion.php'>Salir del Sistema</a>";
            ...
            //significa que ya se ha creado una sesion    
                ...
                echo "<a href='listaproducto.php'>Inicio</a>";
