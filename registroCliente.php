...
<form class="form-horizontal" name="Formulario" method="POST" action="conexioncliente.php">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="correo" name="correo" type="text" placeholder="ejemplo@agenciadefestejos.com" maxlength="40" class="form-control input-md" required="">
